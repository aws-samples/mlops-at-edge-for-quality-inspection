...
cd $SCRIPT_DIR/../inference/lib//assets/gg_components/artifacts/qualityinspection/; zip -r $SCRIPT_DIR/../inference/lib//cdk.out/greengrass_dev/artifacts/qualityinspection.zip . -x "*.DS_Store"
...
# create recipe
sed "s/BUCKET_NAME/${ARTIFACT_BUCKET_NAME}/g;s/COMPONENT_VERSION/${COMPONENT_VERSION}/g" $SCRIPT_DIR/../inference/lib//assets/gg_components/recipes/com.qualityinspection.json > ${OUT_PATH}/recipes/com.qualityinspection.json
# create deployment
